...
<div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center">
    ...
    <br>
    <p>
    <a class="btn btn-outline-secondary" href="#">Electronica</a>
    &nbsp;&nbsp;
    <a class="btn btn-outline-secondary" href="#">Cables</a>
    &nbsp;&nbsp;
    <a class="btn btn-outline-secondary" href="#">Herramientas</a>
</p>
<p>
    <a class="btn btn-outline-secondary" href="#">IIluminacion</a>
    &nbsp;&nbsp;
    <a class="btn btn-outline-secondary" href="#">Otros Productos</a>
    </p>    
</div>
